...
create table utilisateur (
	...
	ut_profil int not null
)engine=innodb;
set foreign_key_checks =1;

-- contraintes
alter table tache add constraint cs1 foreign key (tac_categorie) references categorie(cat_id);
alter table tache add constraint cs2 foreign key (tac_utilisateur) references utilisateur(ut_id);
